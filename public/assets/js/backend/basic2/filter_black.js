define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'basic2/filter_black/index' + location.search,
                    add_url: 'basic2/filter_black/add',
                    edit_url: 'basic2/filter_black/edit',
                    del_url: 'basic2/filter_black/del',
                    multi_url: 'basic2/filter_black/multi',
