define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'basic/circuit/index' + location.search,
                    add_url: 'basic/circuit/add',
                    edit_url: 'basic/circuit/edit',
                    del_url: 'basic/circuit/del',
                    multi_url: 'basic/circuit/multi',
                    table: 'sms_info_circuit',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'circuit_name', title: __('Circuit_name'),operate:'like'},
