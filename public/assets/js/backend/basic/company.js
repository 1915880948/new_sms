define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'basic/company/index' + location.search,
                    add_url: 'basic/company/add',
                    edit_url: 'basic/company/edit',
                    del_url: 'basic/company/del',
                    multi_url: 'basic/company/multi',
                    table: 'sms_info_company',
                }
            });
