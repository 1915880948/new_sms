            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;" class="btn btn-success btn-add <?php echo $auth->check('basic/mobile_attribute/add')?'':'hide'; ?>" title="<?php echo __('Add'); ?>" ><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
                        <a href="javascript:;" class="btn btn-success btn-edit btn-disabled disabled <?php echo $auth->check('basic/mobile_attribute/edit')?'':'hide'; ?>" title="<?php echo __('Edit'); ?>" ><i class="fa fa-pencil"></i> <?php echo __('Edit'); ?></a>
                        <a href="javascript:;" class="btn btn-danger btn-del btn-disabled disabled <?php echo $auth->check('basic/mobile_attribute/del')?'':'hide'; ?>" title="<?php echo __('Delete'); ?>" ><i class="fa fa-trash"></i> <?php echo __('Delete'); ?></a>
                        
                    </div>
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('basic/mobile_attribute/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('basic/mobile_attribute/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
...
<script id="mobilesearch" type="text/html">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <select id="c-vendor_id" class="form-control selectpicker" name="vendor_id" data-live-search="true">
