<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"C:\Apps\PhpStudy2018\PHPTutorial\WWW\new_sms\public/../application/index\view\index\index.html";i:1600134937;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-12">
                        <div class="header-content">
                            <div class="header-content-inner">
                                ...
                                <a href="./admin.php/index/login">登录后台</a>
                            </div>
                        </div>
                    </div>
                </div>
